...
class Retorno_CNAB240 extends Retorno
{
    ...
    public function processarHeader($num, $linha)
    {
        ...
        $mapaHeader = array(
            ...
            'banco' => ['posicao' => [77, 18]],
            'data_gravacao' => ['posicao' => [95, 6], 'formatter' => ['TxtHelper', 'formataData']],
            'sequencial_registro' => ['posicao' => [395, 6]]
 
        );
        
        $mapaFormatado = TxtHelper::toraLinha($linha, $mapaHeader);
    ...
    public function processarDetalhe($num, $linha)
    {
        $mapaDetalhe = array(
            ...
            'taxa_desconto' => ['posicao' => [96, 5], 'formatter' => ['TxtHelper', 'formataNumero']],
            'taxa_iof' => ['posicao' => [101, 5]],

            'carteira' => ['posicao' => [197, 2]],
            'comando' => ['posicao' => [109, 2]],
            'data_ocorrencia' => ['posicao' => [111, 6], 'formatter' => ['TxtHelper', 'formataData']],
            'numero_titulo' => ['posicao' => [117, 10]],
            'data_vencimento' => ['posicao' => [147, 6], 'formatter' => ['TxtHelper', 'formataData']],
            'valor' => ['posicao' => [153, 13], 'formatter' => ['TxtHelper', 'formataNumero']],
            ...
            'valor_tarifa' => ['posicao' => [182, 7], 'formatter' => ['TxtHelper', 'formataNumero']],
            'outras_despesas' => ['posicao' => [189, 13], 'formatter' => ['TxtHelper', 'formataNumero']],
            'juros_desconto' => ['posicao' => [202, 13], 'formatter' => ['TxtHelper', 'formataNumero']],
            'iof_desconto' => ['posicao' => [215, 13], 'formatter' => ['TxtHelper', 'formataNumero']],
            'valor_abatimento' => ['posicao' => [228, 13], 'formatter' => ['TxtHelper', 'formataNumero']],
            'desconto_concedido' => ['posicao' => [241, 13], 'formatter' => ['TxtHelper', 'formataNumero']],
            'valor_recebido' => ['posicao' => [254, 13], 'formatter' => ['TxtHelper', 'formataNumero']],
            'juros_mora' => ['posicao' => [267, 13], 'formatter' => ['TxtHelper', 'formataNumero']],
            'outros_recebimentos' => ['posicao' => [280, 13], 'formatter' => ['TxtHelper', 'formataNumero']],
            'abatimento_nao_aproveitado' => ['posicao' => [293, 13], 'formatter' => ['TxtHelper', 'formataNumero']],
            'valor_lancamento' => ['posicao' => [306, 13], 'formatter' => ['TxtHelper', 'formataNumero']],

            'indicativo_debito_credito' => ['posicao' => [319, 1]],
            'indicador_valor' => ['posicao' => [320, 1]],
            'valor_ajuste' => ['posicao' => [321, 12], 'formatter' => ['TxtHelper', 'formataNumero']],

            'canal_pagamento_titulo' => ['posicao' => [393, 2]],
            'sequencial' => ['posicao' => [395, 6]]
        );

        $mapaFormatado = TxtHelper::toraLinha($linha, $mapaDetalhe);
    ...
    public function processarTrailer($num, $linha)
    {
        ...
        $mapaFormatado = TxtHelper::toraLinha($linha, $mapaTrailer);
